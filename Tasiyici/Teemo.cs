...
namespace Marksman
{
    internal class Teemo : Champion
    {
        ...
        public Teemo()
        {
            Utils.PrintMessage("Teemo yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRC" + Id, "Ulti Kullan").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseQM" + Id, "Q ile KS yap").SetValue(true));
            return true;
        }

        public override bool ExtrasMenu(Menu config)
        {
            config.AddItem(new MenuItem("AutoRI" + Id, "Ulti Kullan").SetValue(true));
            return true;
        }
