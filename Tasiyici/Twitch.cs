...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public Twitch()
        {
            Utils.PrintMessage("Twitch yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "E'yi maximum stack ile kullan").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "E'yi maximum stack ile kullan").SetValue(false));
            return true;
        }
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            var dmgAfterComboItem = new MenuItem("DamageAfterCombo", "Combodan sonra hasar").SetValue(true);
        ...
        {
            config.AddItem(new MenuItem("UseEM" + Id, "E ile KS At").SetValue(true));
            return true;
        }
