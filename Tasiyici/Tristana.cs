...
namespace Marksman
{
    internal class Tristana : Champion
    {
        ...
        public Tristana()
        {
            ...
            Utils.PrintMessage("Tristana yuklendi.");
        }
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseWCS" + Id, "E stacklerini W ile tamamla").SetValue(true));
            config.AddItem(new MenuItem("UseEC" + Id, "Use E").SetValue(true));

            config.AddSubMenu(new Menu("E Kullanma", "DontUseE"));
            {
        ...
        {
            config.AddItem(new MenuItem("UseQH" + Id, "Q Kullan").SetValue(false));
            config.AddItem(new MenuItem("UseWH" + Id, "W Kullan").SetValue(true));
            config.AddItem(new MenuItem("UseEH" + Id, "E Kullan").SetValue(true));
            config.AddItem(
                new MenuItem("UseETH" + Id, "E kullan (Gecis)").SetValue(
        ...
        {
            config.AddItem(new MenuItem("DrawW" + Id, "W menzili").SetValue(new Circle(true, Color.Beige)));

            var drawE = new Menu("E Kullan", "DrawE");
            {
                drawE.AddItem(new MenuItem("DrawE", "E menzili").SetValue(new Circle(true, Color.Beige)));
                drawE.AddItem(
                    new MenuItem("DrawEMarkEnemy", "Dusmanlari E ile isaretle").SetValue(new Circle(true, Color.GreenYellow)));
                drawE.AddItem(new MenuItem("DrawEMarkStatus", "E isaretleme durumu").SetValue(true));
                config.AddSubMenu(drawE);
            }

            var dmgAfterComboItem = new MenuItem("DamageAfterCombo", "Combo sonrasi hasar.").SetValue(true);
        ...
        {
            config.AddItem(new MenuItem("UseWM" + Id, "W ile Kill Cal").SetValue(true));
            config.AddItem(new MenuItem("UseRM" + Id, "R ile Kill Cal").SetValue(true));
            config.AddItem(new MenuItem("UseRMG" + Id, "R ile arayi ac").SetValue(true));
            config.AddItem(new MenuItem("UseRMI" + Id, "R ile kes").SetValue(true));
            return true;
        }
