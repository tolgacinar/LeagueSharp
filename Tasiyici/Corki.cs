...
namespace Marksman
{
    internal class Corki : Champion
    {
        ...
        public Corki()
        {
            Utils.PrintMessage("Corki yuklendi");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "Ulti stacklerini tut").SetValue(new Slider(0, 0, 7)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "E Kullan").SetValue(false));
            config.AddItem(new MenuItem("UseRH" + Id, "R Kullan").SetValue(true));
            config.AddItem(new MenuItem("RlimH" + Id, "Ulti stacklerini tut").SetValue(new Slider(3, 0, 7)));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseRM" + Id, "Ulti kullanarak kill cal").SetValue(true));
            return true;
        }
