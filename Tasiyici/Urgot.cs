...
namespace Marksman
{
    internal class Urgot : Champion
    {
        ...
        public Urgot()
        {
            Utils.PrintMessage("Urgot yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddSubMenu(new Menu("Ulti Ayarlari 1", "UltOpt1"));

            config.SubMenu("UltOpt1")
                .AddItem(
                    new MenuItem("UltOp1" + Id, "Dusmani Kuleye Isinla").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));

            config.AddSubMenu(new Menu("Ulti Ayarlari 2", "UltOpt2"));
            config.SubMenu("UltOpt2")
                .AddItem(
                    new MenuItem("UltOp2" + Id, "Dusmani Takima Isinla").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Press)));
            config.SubMenu("UltOpt2")
                .AddItem(new MenuItem("UltOp2Count" + Id, "Min. Dusman Sayisi").SetValue(new Slider(1, 1, 5)));


            config.AddSubMenu(new Menu("Ulti kullanimi kapali", "DontUlt"));
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q menzili").SetValue(new Circle(true, Color.LightGray)));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E menzili").SetValue(new Circle(false, Color.LightGray)));
            config.AddItem(
                new MenuItem("DrawR" + Id, "R menzili").SetValue(new Circle(false, Color.LightGray)));
            config.AddItem(
