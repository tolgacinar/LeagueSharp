...
namespace Marksman
{
    internal class Kogmaw : Champion
    {
        ...
        public Kogmaw()
        {
            Utils.PrintMessage("KogMaw yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "R Limitleyici").SetValue(new Slider(3, 5, 1)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "R Kullan").SetValue(false));
            config.AddItem(new MenuItem("UseRH" + Id, "Ulti Kullan").SetValue(true));
            config.AddItem(new MenuItem("RlimH" + Id, "R Limitleyici").SetValue(new Slider(1, 5, 1)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q menzili").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W menzili").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E menzili").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawR" + Id, "R menzili").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            return true;
        }
