...
namespace Marksman
{
    internal class Quinn : Champion
    {
        ...
        public Quinn()
        {
            Utils.PrintMessage("Quinn yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETC" + Id, "Kulenin altinda E Kullanma").SetValue(true));
            config.AddItem(new MenuItem("UseETK" + Id, "Kule altindan E ile skor cikar")
                .SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETH" + Id, "Kulenin altinda E kullanma").SetValue(true));
            config.AddItem(
