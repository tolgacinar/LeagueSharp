...
namespace Marksman
{
    internal class Caitlyn : Champion // Base done by xQx, Drawings and improvements added by Dibes.
    {
        ...
        public Caitlyn()
        {
            Utils.PrintMessage("Caitlyn yuklendi.");
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("DrawUlt" + Id, "Ult Yazisi").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("UltHelp" + Id, "Secili Kisiye Ulti At").SetValue(new KeyBind("R".ToCharArray()[0],
                    KeyBindType.Press)));
            config.AddItem(
                new MenuItem("UseEQC" + Id, "E-Q Kombosu Kullan").SetValue(new KeyBind("T".ToCharArray()[0],
                    KeyBindType.Press)));
            config.AddItem(
                new MenuItem("Dash" + Id, "Mouse ile").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
            return true;
        }
