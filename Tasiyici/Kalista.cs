...
namespace Marksman
{
    ...
    internal class Kalista : Champion
    {
        ...
        public Kalista()
        {
            Utils.PrintMessage("Kalista yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "E Kullan").SetValue(true));
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseWH" + Id, "W Kullan").SetValue(true));
            config.AddItem(
                new MenuItem("UseQTH" + Id, "Q Kullan (Gecis)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q menzili").SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W menzili").SetValue(new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E menzili").SetValue(new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(
                new MenuItem("DrawR" + Id, "R menzili").SetValue(new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(new MenuItem("Dx" + Id, ""));
            config.AddItem(
                new MenuItem("DrawConnMax" + Id, "Baglanti Menzili").SetValue(new Circle(false,
                    Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(
                new MenuItem("DrawConnText" + Id, "Baglanti Yazisi").SetValue(new Circle(false, Color.GreenYellow)));
            config.AddItem(
                new MenuItem("DrawConnSignal" + Id, "Baglanti Sinyali").SetValue(true));
            config.AddItem(new MenuItem("Dx" + Id, ""));
            config.AddItem(
                new MenuItem("DrawEStackCount" + Id, "E Stack Sayisi").SetValue(new Circle(false, Color.Firebrick)));
            config.AddItem(new MenuItem("Dx", ""));
            config.AddItem(
                new MenuItem("DrawJumpPos" + Id, "Ziplama Pozisyonu").SetValue(new Circle(false, Color.HotPink)));

            var damageAfterE = new MenuItem("DamageAfterE", "E kullandiktan sonra hasar").SetValue(true);
