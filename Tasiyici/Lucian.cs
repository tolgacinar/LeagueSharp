...
namespace Marksman
{
    internal class Lucian : Champion
    {
        ...
        public Lucian()
        {
            Utils.PrintMessage("Lucian yuklendi.");
...
//                    .SetValue(ObjectManager.Player.Spellbook.GetSpell(SpellSlot.R).Name == "LucianR");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseQExtendedC" + Id, "Genisletilmis Q Kullan").SetValue(true));
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseQTH" + Id, "Q Kullan (Gecis)").SetValue(new KeyBind("T".ToCharArray()[0],
                    KeyBindType.Toggle)));
            config.AddItem(new MenuItem("Cx",""));
            config.AddItem(new MenuItem("UseQExtendedH" + Id, "Genisletilmis Q kullan").SetValue(true));
            config.AddItem(
                new MenuItem("UseQExtendedTH" + Id, "Genisletilmis Q (Gecis)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));
            config.AddItem(new MenuItem("Cx", ""));
        ...
        {
            config.AddItem(new MenuItem("Passive" + Id, "Pasifi kontrol et").SetValue(true));
            return true;
        }

        public override bool DrawingMenu(Menu config)
        {
            config.AddItem(new MenuItem("DrawQ" + Id, "Q menzili").SetValue(new Circle(true, Color.Gray)));
            config.AddItem(new MenuItem("DrawQ2" + Id, "Genisletilmis Q menzili").SetValue(new Circle(true, Color.Gray)));
            config.AddItem(new MenuItem("DrawW" + Id, "W menzili").SetValue(new Circle(false, Color.Gray)));
            config.AddItem(new MenuItem("DrawE" + Id, "E menzili").SetValue(new Circle(false, Color.Gray)));
