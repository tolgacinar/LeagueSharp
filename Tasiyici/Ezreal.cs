...
namespace Marksman
{
    internal class Ezreal : Champion
    {
        ...
        public Ezreal()
        {
            ...
            Utils.PrintMessage("Ezreal yuklendi.");
        }
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            {
                xRMenu.AddItem(new MenuItem("UseRC", "Kullan").SetValue(true));
                xRMenu.AddItem(new MenuItem("UseRCMinRange", "Min. Menzil").SetValue(new Slider(200, 200, 1000)));
                xRMenu.AddItem(new MenuItem("UseRCMaxRange", "Max. Menzil").SetValue(new Slider(500, 500, 2000)));
                xRMenu.AddItem(
                    new MenuItem("DrawRMin", " Min. R Menzili Cizimi").SetValue(
                        new Circle(true, System.Drawing.Color.DarkRed)));
                xRMenu.AddItem(
                    new MenuItem("DrawRMax", " Max. R Menzili Cizimi").SetValue(
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddSubMenu(new Menu("Gecis ile Q kullanma", "DontQToggleHarass"));
            config.AddSubMenu(new Menu("Gecis ile W kullanma", "DontWToggleHarass"));
            {
            ...
            config.AddItem(
                new MenuItem("UseQTH", "Q (Gecis)").SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(
                new MenuItem("UseWTH", "W (Gecis)").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(new MenuItem("DrawHarassToggleStatus", "Gecis Durumu Cizimi").SetValue(true));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q menzili").SetValue(
                    new Circle(true, System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W menzili").SetValue(
                    new Circle(false, System.Drawing.Color.FromArgb(100, 255, 255, 255))));
            config.AddItem(new MenuItem("ShowKillableStatus", "Oldurulebilir durumu goster").SetValue(true));

            var dmgAfterComboItem = new MenuItem("DamageAfterCombo", "Kombo sonrasi hasar").SetValue(true);
        ...
        {
            config.AddItem(new MenuItem("UseQL" + Id, "Q Kullan").SetValue(true));
            return true;
        }
