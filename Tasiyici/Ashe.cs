...
namespace Marksman
{
    internal class Ashe : Champion
    {
        ...
        public Ashe()
        {
            ...
            Utils.PrintMessage("Ashe yuklendi.");
        }
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            var xRMenu = new Menu("R", "ComboR");
            {
                ...
                xRMenu.AddItem(
                    new MenuItem("DrawRMin", "Min. R Menzil Cizimi").SetValue(
                        new Circle(true, System.Drawing.Color.DarkRed)));
                xRMenu.AddItem(
                    new MenuItem("DrawRMax", "Max. R Menzil Cizimi").SetValue(
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseWTH", "W Kullan (Gecis)").SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle)));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("DrawW" + Id, "W menzili").SetValue(new Circle(true, Color.CornflowerBlue)));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E menzili").SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
        ...
        {
            config.AddItem(new MenuItem("RInterruptable" + Id, "Buyuleri kesmek icin ulti kullan").SetValue(true));
            config.AddItem(new MenuItem("EFlash" + Id, "Flash Atanlara E Kullan").SetValue(true));
            config.AddItem(new MenuItem("RManualCast" + Id, "Akilli Ulti Manuel(2000 menzil)"))
