...
namespace Marksman
{
    internal class Sivir : Champion
    {
        ...
        public Sivir()
        {
            Utils.PrintMessage("Sivir yuklendi.");
        ...
        {
            config.AddItem(new MenuItem("AutoQ" + Id, "Q Kullan - Stun/Slow/Fear/Taunt/Snare").SetValue(true));

            _menuSupportedSpells = new Menu("E destekleyen yetenekler", "suppspells");
