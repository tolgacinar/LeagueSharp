...
namespace Marksman
{
    internal class MissFortune : Champion
    {
        ...
        public MissFortune()
        {
            Utils.PrintMessage("MissFortune yuklendi.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseQMC", "Q kullan (minyonlardan dusmana sektir)").SetValue(true));
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseQTH" + Id, "Q Kullan (Gecis)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));
            config.AddItem(
                new MenuItem("UseETH" + Id, "E Kullan (Gecis)").SetValue(new KeyBind("T".ToCharArray()[0],
                    KeyBindType.Toggle)));
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("DrawE" + Id, "E menzili").SetValue(
